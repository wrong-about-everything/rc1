                    ...
                    new OutboundRequest(
                        ...
                        new BotApiUrl(
                            ...
                            new FromArray([
                                ...
                                'text' => sprintf('Раунд встреч уже идёт или уже прошёл. Мы пришлём вам приглашение на новый раунд, как только о нём станет известно. Если хотите что-то спросить или уточнить, смело пишите на @%s', $supportBotName->value()->pure()->raw()),
                            ]),
