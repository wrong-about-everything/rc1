...
use RC\Domain\RoundInvitation\Status\Pure\UserRegistered as UserRegisteredStatus;
...
class UserRegistered implements Invitation
{
...
q
                ,
                [(new UserRegisteredStatus())->value(), $this->roundInvitationId->value()->pure()->raw()],
                $this->connection
            ))
                ->response();
