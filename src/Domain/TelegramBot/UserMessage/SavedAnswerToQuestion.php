...
namespace RC\Domain\TelegramBot\UserMessage;
...
use RC\Domain\RegistrationQuestionId\Pure\RegistrationQuestionId as PureRegistrationQuestionId;
...
class SavedAnswerToQuestion implements UserMessage
{
