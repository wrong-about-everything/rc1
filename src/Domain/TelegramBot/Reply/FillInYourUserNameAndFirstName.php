...
class FillInYourUserNameAndFirstName implements Reply
{
...
Если хотите сохранить инкогнито, вы вполне можете указать вымышленное имя. Если не знаете, какой ник выбрать, попробуйте этот — %s. Обещать не могу, но, думаю, он свободен. 
t
                                        ,
                                        time()
                                    )
