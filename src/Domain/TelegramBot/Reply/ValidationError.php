...
class ValidationError implements Reply
{
    ...
    public function __construct(AnswerOptions $answerOptions, TelegramUserId $telegramUserId, BotToken $botToken, HttpTransport $httpTransport)
    {
                            ...
                            new FromArray(
                                array_merge(
                                    [
                                        ...
                                        'text' => 'К сожалению, мы пока не можем принять ответ в виде текста. Поэтому выберите, пожалуйста, один из вариантов ответа. Если ни один не подходит -- напишите в @gorgonzola_support',
                                    ],
