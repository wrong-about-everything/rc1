...
use RC\Infrastructure\Filesystem\FilePath\Moved;
...
{
    public function testWhenOriginFileDoesNotExistThenItIsNotMoved()
    {
        $dir =
            new Moved(
    ...
    public function testWhenBothOriginAndDestinationFilesExistThenOriginIsNotMoved()
    {
        (new Created(
            new FromDirAndFileName(new Tmp(), new PortableFromString('vasya')),
            new Emptie()
    ...
    public function testWhenOriginFileExistsAndDestinationDoesNotThenOriginIsMoved()
    {
        (new Created(
            new FromDirAndFileName(new Tmp(), new PortableFromString('vasya')),
            new FromString('Hey!')
